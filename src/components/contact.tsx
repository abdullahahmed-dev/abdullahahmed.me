...
const SocialLinkItem = memo(
  ({ link, delay }: { link: SocialLink; delay: number }) => (
    ...
    <div className="flex flex-col items-start space-y-4">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground text-sm/relaxed md:text-base/relaxed lg:text-sm/relaxed xl:text-base/relaxed max-w-[600px]">
          ...
          <Link
            href="mailto:abdullahmujadad@outlook.com"
            className="underline hover:text-gray-600 dark:hover:text-gray-400"
          >
            email
          </Link>{" "}
          or connect through any of these platforms. I&apos;m always open to
...
const ContactSection = () => {
  return (
    <section
      id="contact"
      className="space-y-6 sm:space-y-12 w-full max-w-[900px] py-12 pb-20 sm:pb-12"
    >
      <ContactHeader />
